...
enum Map: int implements HasLabel
{
    ...
    case EventSquare = 82;
    case VIPArena2 = 83;
    case EventSquare4 = 84;
    case Ashkavor = 85;
    case Dungeon2 = 86;
    case Citadel = 87;
    case Icewrack = 89;
    case Yoskreth = 90;
    case EventSquare2 = 91;
    case EventSquare3 = 92;
    case Debenter = 95;
    case Debenter2 = 96;
    ...
    public function getLabel(): string
    {
        return match ($this) {
            ...
            self::Exile => 'Exile',
            self::VIPArena, self::VIPArena2, self::VIPArena4, self::VIPArena3 => 'VIP Arena',
            self::Atlans => 'Atlans',
            self::Tarkan => 'Tarkan',
            self::DevilSquareI_IV, self::DevilSquareV_VI => 'Devil Square',
            self::Icarus => 'Icarus',
            self::BloodCastleI, self::BloodCastleVIII, self::BloodCastleVII, self::BloodCastleVI, self::BloodCastleV, self::BloodCastleIV, self::BloodCastleIII, self::BloodCastleII => 'Blood Castle',
            self::ChaosCastleI, self::ChaosCastleVII, self::ChaosCastleVI, self::ChaosCastleV, self::ChaosCastleIV, self::ChaosCastleIII, self::ChaosCastleII => 'Chaos Castle',
            self::KalimaI => 'Kalima',
            ...
            self::IllusionTempleI, self::IllusionTempleVI, self::IllusionTempleV, self::IllusionTempleIV, self::IllusionTempleIII, self::IllusionTempleII => 'Illusion Temple',
            ...
            self::DoppelGangerI, self::DoppelGangerIV, self::DoppelGangerIII, self::DoppelGangerII => 'Doppel Ganger',
            self::ImperialGuardianI, self::ImperialGuardianII, self::ImperialGuardianIII, self::ImperialGuardianIV => 'Imperial Guardian',
            self::LorenMarket => 'Loren Market',
            self::Karutan => 'Karutan',
            self::Karutan2 => 'Karutan II',
            self::EventSquare, self::EventSquare2, self::EventSquare3, self::EventSquare4 => 'Event Square',
            ...
            self::TormentedSquareBattleI, self::TormentedSquareBattleII, self::TormentedSquareBattleIII, self::TormentedSquareBattleIV => 'Tormented Square Battle',
            self::Nars => 'Nars',
            self::Ferea => 'Ferea',
