    ...
    */
    ...
    'connections' => [
        ...
        'gamedb_x200' => [
            'driver' => 'sqlsrv',
            'url' => env('DB_URL'),
            'host' => env('X200_DB_HOST', 'localhost'),
            'port' => env('X200_DB_PORT', '1433'),
            'database' => env('X200_DB_DATABASE', 'laravel'),
            'username' => env('X200_DB_USERNAME', 'root'),
            'password' => env('X200_DB_PASSWORD', ''),
            'charset' => env('DB_CHARSET', 'utf8'),
            'prefix' => '',
            'prefix_indexes' => true,
            // 'encrypt' => env('DB_ENCRYPT', 'yes'),
