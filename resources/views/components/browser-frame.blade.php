...
<div {{ $attributes->merge(['class' => 'mt-4 -mx-6 sm:mx-0 lg:mt-0']) }}>
    <div
        class="relative overflow-hidden shadow-xl flex bg-zinc-800 sm:rounded-xl dark:bg-zinc-900/70 dark:backdrop-blur dark:ring-1 dark:ring-inset dark:ring-white/10 {{ $aspect }}">
