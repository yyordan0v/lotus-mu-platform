        ...
        <flux:columns>
            ...
            <flux:column>
                <div class="flex items-center gap-2">
                    ...
                    <flux:modal.trigger name="hunter-score-info">
                        <flux:button icon="information-circle" size="sm" inset="top bottom" variant="ghost"/>
                    </flux:modal.trigger>

                    <flux:modal name="hunter-score-info" variant="flyout" position="bottom" class="space-y-6">
                        <div>
            ...
            <flux:column>
                <div class="flex items-center gap-2">
                    <span>Hunt Score All Time</span>

                    <flux:modal.trigger name="hunter-score-info-all-time">
                        <flux:button icon="information-circle" size="sm" inset="top bottom" variant="ghost"/>
                    </flux:modal.trigger>

                    <flux:modal name="hunter-score-info-all-time" variant="flyout" position="bottom" class="space-y-6">
                        <div>
                            <flux:heading size="lg">Monster Score Table</flux:heading>
                            <flux:subheading>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. At,
        ...
        <flux:rows>
            @foreach($this->characters as $character)
                <flux:row wire:key="{{ $character->Name }}">
                    ...
                    <flux:cell>
                        <div>
                            <flux:modal.trigger name="hunter-score-{{ $character->Name }}">
                                <flux:button size="sm" variant="ghost" inset="top bottom" icon-trailing="chevron-down">
                                    <span>{{ rand(400,900) }}</span>
                                </flux:button>
                            </flux:modal.trigger>

                            <flux:modal name="hunter-score-{{ $character->Name }}" variant="flyout" position="bottom"
                                        class="space-y-6">
                                <div>
                    ...
                    <flux:cell>
                        <div>
                            <flux:modal.trigger name="hunter-score-total-{{ $character->Name }}">
                                <flux:button size="sm" variant="ghost" inset="top bottom" icon-trailing="chevron-down">
                                    <span>{{ rand(4000,9000) }}</span>
                                </flux:button>
                            </flux:modal.trigger>

                            <flux:modal name="hunter-score-total-{{ $character->Name }}" variant="flyout"
                                        position="bottom"
                                        class="space-y-6">
                                <div>
                                    <flux:heading size="lg">{{ $character->Name }} Hunt Score</flux:heading>
